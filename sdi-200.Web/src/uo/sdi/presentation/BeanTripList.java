...
public class BeanTripList implements Serializable {
	...
	listaViajes = Factories.services.getTripService()
	...
	if (viajeSeleccionado != null) {
	    ...
	    try {
		this.pasajeros = Factories.services.getUserService()
		...
		request.setAttribute("viaje", viajeSeleccionado);
	...
	try {
	    ...
	    Factories.services.getApplicationService().applicateForTrip(
		    idViaje, idUsuario);
