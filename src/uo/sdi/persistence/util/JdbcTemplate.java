...
public class JdbcTemplate
{
	...
	{
		if (arg == null) { ps.setNull(idx, java.sql.Types.OTHER); }
		
		else if (arg instanceof String) { ps.setString(idx, (String) arg); }
		
		else if (arg instanceof Integer) { ps.setInt(idx, (int) arg); }
		
		else if (arg instanceof Long) { ps.setLong(idx, (long) arg); }
		
		else if (arg instanceof Double) { ps.setDouble(idx, (double) arg); }
		...
		else if (arg instanceof Boolean) { ps.setBoolean(idx, (boolean) arg); }
		
		else if (arg instanceof Float) { ps.setFloat(idx, (float) arg); }
		...
		else if (arg instanceof Short) { ps.setShort(idx, (short) arg); }
		
		else if (arg instanceof Byte) { ps.setByte(idx, (byte) arg); }
		
		else if (arg instanceof Byte[]) { ps.setBytes(idx, (byte[]) arg); }
		
		else { ps.setObject(idx, arg); }
	}
}