...
/**
 * Contiene las opciones del menu y las ejecuta.
 */
public abstract class BaseMenu implements Action {
    ...
    protected void processOption(int option, MessagingClient client)
	    throws Exception {
	if (option == EXIT)
	    return;
	...
	createInstanceOf(actionClass).execute(client);
    }
