...
public class BeanTripRegistry {
    ...
    /**
     * Comprueba si el usuario relleno el campo provincia de salida en la vista
     ...
     * 
     * @return cambia segun el componente que lo llame. Le indicara al
     *         componente si debe renderizarse (solo se renderizara el "1" o el
     *         "2", pero no ambos a la vez)
     * 
     */
	...
	// Componente 1 --> tiene funcion autocompletado
	if (componente.equals("1")) {
	    // true si hay que enseñar las opciones (posibles ciudades)
	    return mostrar == true;
	}

	// Componente 2 --> no tiene funcion autocompletado
	else {
	    // true si no hay que enseñar las opciones (posibles ciudades)
